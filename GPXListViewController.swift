...
class GPXListViewController: UITableViewController, UINavigationBarDelegate {
    
    var fileList: NSMutableArray = [kNoFiles]
    var gpxFilesFound = false;
    var selectedRowIndex = -1
    weak var delegate: GPXListViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        self.title = "Personal Feed"
        
        let shareItem = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.plain, target: self, action: #selector(GPXListViewController.closeGPXListViewController))
    ...
    func closeGPXListViewController() {
        print("Close this view Controller()")
    ...
    internal func actionLoadFileAtIndex(_ rowIndex: Int) {
        ...
        self.delegate?.didLoadGPX(filename, gpxRoot: gpx!)
...
extension GPXListViewController: UIActionSheetDelegate{
...
extension GPXListViewController: MFMailComposeViewControllerDelegate {
